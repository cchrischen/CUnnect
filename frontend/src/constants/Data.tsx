...
export const sampleData: Event[] = [
    {title: "dinner", now: true, host:"john", location:"bethe"},
    ...
    {title: "breakfast", now: true, host:"georgina", location:"morrison"},
    {title: "volleyball", now: false, host: "bob", location: "court by ckb", days:["Mo"], time:{startHr:10, startMin: 0, endHr: 11, endMin: 30}},
    {title: "free food giveaway", now: true, host:"joe", location:"rbg"}
]
