    ...
    return (
      <>
        <TimeChooser
          ...
          MenuProps={MenuProps}
          defaultValue={1}
          className={props.timeType}
        >
          {upTo12.map((num) => {
            return (
              <MenuItem value={num} key={num}>
                {handleTimeToString(num)}
              </MenuItem>
            );
          })}
        </TimeChooser>
          ...
          <Stack>
            <Box>
              <Stack direction="row" justifyContent="space-around">
                <Button
                  color="secondary"
                  variant={now === true ? "contained" : "outlined"}
                ...
                <Button
                  color="secondary"
                  variant={now === false ? "contained" : "outlined"}
                >
                  <ButtonText onClick={() => handleTimeChange("notnow")}>
                    Later
                  </ButtonText>
                </Button>
              </Stack>
