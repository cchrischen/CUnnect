...
export const allDaysOfWeek: string[] = [
  "Monday",
  "Tuesday",
  "Wednesday",
  "Thursday",
...
export const tempEvent: Event = {
  ...
  users: ["cc2785", "jd1"],
  id: "",
  time: { startHr: -1, startMin: -1, endHr: -1, endMin: -1 },
  hostNetid: "cc2785",
  messages: [
    { message: "howdy", author: "Chris", netid: "cc2785" },
    {
      message:
    ...
    {
      message:
        "g elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ul",
      author: "John",
      netid: "jd1",
    },
    {
